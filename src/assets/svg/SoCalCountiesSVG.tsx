...
const SoCalCountiesSVG = ({
  ...
  hoverIndex: string;
  setHoverIndex: React.Dispatch<React.SetStateAction<string>>;
  indexCounter: number;
}) => {
  ...
  return (
    ...
    >
      ...
      {/* Kern County */}
      <path
        className={hoverIndex == "0" ? "kern-yes-hover" : "kern-no-hover"}
      ...
      <path
        className={hoverIndex == "1" ? "sanLuis-yes-hover" : "sanLuis-no-hover"}
      ...
      <path
        className={hoverIndex == "2" ? "sanBar-yes-hover" : "sanBar-no-hover"}
      ...
      {/* Ventura County */}
      <path
        className={hoverIndex == "3" ? "ven-yes-hover" : "ven-no-hover"}
      ...
      {/* Los Angeles County */}
      <path
        className={hoverIndex == "4" ? "losAng-yes-hover" : "losAng-no-hover"}
      ...
      <path
        className={hoverIndex == "5" ? "sanBern-yes-hover" : "sanBern-no-hover"}
      ...
      {/* Riverside */}
      <path
        className={hoverIndex == "6" ? "river-yes-hover" : "river-no-hover"}
      ...
      {/* Orange */}
      <path
        className={hoverIndex == "7" ? "orange-yes-hover" : "orange-no-hover"}
      ...
      >
        ...
        <path
          className={
            hoverIndex == "8" ? "imperial-yes-hover" : "imperial-no-hover"
          }
      ...
      <path
        className={
          hoverIndex == "9" ? "sanDiego-yes-hover" : "sanDiego-no-hover"
        }
